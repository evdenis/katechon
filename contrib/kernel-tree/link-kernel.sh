...
sed -i '/default "yama,loadpin,safesetid,integrity,tomoyo" if DEFAULT_SECURITY_TOMOYO/a \\tdefault "yama,loadpin,safesetid,integrity,katechon" if DEFAULT_SECURITY_KATECHON' "$K/security/Kconfig"
